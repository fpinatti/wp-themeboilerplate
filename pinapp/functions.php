...
function pinapp_script_enqueue() {
	...
	wp_enqueue_style('customstyle', get_template_directory_uri() . '/css/pinapp.css', array(), '1.0.0', 'all');
	//js
	wp_enqueue_script('jquery');
	wp_enqueue_script('bootstrapjs', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '3.3.4', true);
	wp_enqueue_script('customjs', get_template_directory_uri() . '/js/pinapp.js', array(), '1.0.0', true);
