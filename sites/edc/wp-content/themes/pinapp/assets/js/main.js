...
document.addEventListener("DOMContentLoaded", function () {
  var btnSandwichOpen = document.querySelector('.icon-sandwich');
  var btnSandwichClose = document.querySelector('.icon-sandwich-back');
  ...
  var momkid = document.querySelector('.footer-mom-kid');
  ...
  var figures = document.querySelectorAll('figure.responsive img');
  figures.forEach(function (img) {
    var pictureElement = document.createElement('picture');
    var source1Element = document.createElement('source');
    var source2Element = document.createElement('source');
  ...
  function getLargeImg(src) {
    ...
    var pathname = src.substring(0, src.lastIndexOf('/'));
...
},{}]},{},["C:/Users/Pinatti/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main.js"], null)
